...
| 2026-06-10 | raw/2026-06-10_anthropic_aei/ | https://huggingface.co/datasets/Anthropic/EconomicIndex | Anthropic Economic Index: occupation-level job_exposure.csv plus v2 task-level usage and automation/augmentation files (11 files, pinned to revision db51ecb) | Claude (DATA-1 agent) | LANDED 2026-06-10 via Mac fetch script, all 11 files verified against pinned blobs (job_exposure: 756 occupations); data CC-BY, code MIT; see PROVENANCE.md |
| 2026-06-10 | raw/2026-06-10_oews/ | https://www.bls.gov/oes/special-requests/oesm25in4.zip | BLS OEWS May 2025 national industry-specific estimates: occupation employment by NAICS at sector/3/4/5-digit levels plus ownership, full XLSX zip + extract (engine backbone) | Claude (DATA-2 agent) | LANDED 2026-06-10 via Mac fetch script, sha256 verified, all 9 zip members extracted (note: double-nested oesm25in4/oesm25in4/); May 2025 is newest vintage (verified on tables.htm); public domain; see PROVENANCE.md |
| 2026-06-10 | raw/2026-06-10_abs_ownerage/ | https://api.census.gov/data/2023/abscbo | Census ABS 2023 Characteristics of Business Owners: owner age question by NAICS sector, US level, owner counts + percent shares, raw JSON + flattened CSV (succession context) | Claude (DATA-2 agent) | LANDED 2026-06-10 via Mac fetch script (raw JSON 29MB + flat CSV 23.7MB + discovery JSON), owner-age question O09/OWNRAGE confirmed; 2023 is newest vintage (no 2024 endpoint); sector level only; CC0; see PROVENANCE.md |
| 2026-06-10 | raw/2026-06-10_bds_firmage/ | https://www2.census.gov/programs-surveys/bds/tables/time-series/2023/bds2023_vcn4_fa.csv | Census BDS 2023 two-way table, firm age by 4-digit NAICS, 1978-2023 CSV (succession complement check) | Claude (DATA-2 agent) | LANDED 2026-06-10 via Mac fetch script (19.1MB CSV, 1978-2023); BDS 2023 is newest vintage; public domain; see PROVENANCE.md |
